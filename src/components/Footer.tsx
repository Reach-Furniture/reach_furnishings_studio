...
const Footer = () => {
  const footerLinks = [
    { label: "About REACH Furnishings Studio", path: "/about" },
    { label: "Benefits of REACH Furnishings Studio", path: "/benefits" },
    // { label: "Learning Guides", path: "/learningguide" },
    // { label: "Presentations", path: "/presentations" },
    { label: "REACH Furnishings Studio Images", path: "/rmmimages" },
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div>
            <Link to="/" className="text-2xl font-bold mb-4 block w-fit">
              <span className="text-primary">REACH</span> Furnishings Studio
            </Link>
            <p className="text-gray-300 max-w-md">
              Best In Class Furnishings Studio Software
            </p>
            ...
            <div className="mt-6 space-y-4">
              ...
              <div className="flex items-center gap-3">
                <img src={emailIcon} alt="Email icon for REACH Furnishing Studio" className="w-8 icon-a03359" />
              ...
              >
                <img src={whatsappIcon} alt="Whatsapp icon for REACH Furnishing Studio" className="w-8 icon-a03359" />
                <span className="text-gray-300 text-lg">
                  +91 84592 78496
                </span>
              </a>
              ...
              >
                <img src={contactIcon} alt="Contact form link icon for REACH Furnishing Studio" className="w-7 icon-a03359" />
                <span className="text-gray-300 text-lg">
                  Write to Us
                </span>
              </a>
